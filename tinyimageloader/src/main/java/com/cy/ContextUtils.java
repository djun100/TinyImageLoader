    ...
    public static Context getContext() {
        if (mContext == null) {
            try {
                ...
                if (application != null) {
//                    Log.e(ContextUtils.class.getName(), "context gotten by ActivityThread#currentApplication");
            ...
            try {
                Application application = (Application) Class
                        ...
                        .invoke(null, (Object[]) null);
                if (application != null) {
//                    Log.e(ContextUtils.class.getName(), "context gotten by AppGlobals#getInitialApplication.");
                    mContext = application;
                    return application;
                }
            } catch (Exception e) {
